...
public class aobPatientAdapter extends RecyclerView.Adapter<aobViewHolder>
{
    ...
    public aobPatientAdapter(List<aobData> list, Context context)
    {
        this.list = list;
                                 ...
                                 final int position)
    {
        ...
        viewHolder.btn_aob_comment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view){
                ...
                Intent i = new Intent(context, aob_comment_patient.class);
        ...
        viewHolder.btn_aob_update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view){
                ...
                Intent i = new Intent(context, update_aob_patient.class);
                i.putExtra("AOB Id", list.get(position).aob_id);
                i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                context.startActivity(i);
