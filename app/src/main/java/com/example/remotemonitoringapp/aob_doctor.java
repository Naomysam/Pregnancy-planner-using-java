 ...
 public class aob_doctor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       getSupportActionBar().setTitle("AOB");
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(aob_doctor.this, upload_aob_doctor.class);
     ...
     public void start_comm_activity() {
         Intent i = new Intent(getApplicationContext(), communication_doctor.class);
     ...
     public void load_recycler(String json) throws JSONException
     {
         ...
         recyclerView.setLayoutManager(new LinearLayoutManager(aob_doctor.this));
                     ...
                     public void onResponse(String response) {
                         ...
                         try {
                             ...
                             if (success == 1) {
                                 ...
                                 Toast.makeText(aob_doctor.this, "Failed to get user information.", Toast.LENGTH_LONG).show();
                             }
