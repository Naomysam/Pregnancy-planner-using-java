...
public class patientRegister extends AppCompatActivity {
    ...
    private String RegCompanyName, RegPatientDept;
...
//// Apply the adapter to the spinner
        ...
        reg_employee_position.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener()
        {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                Toast.makeText(patientRegister.this,radioButton.getText(),Toast.LENGTH_LONG).show();
            }
        });
    ...
    public void register() {
        ...
        if (!STRING_EMPTY.equals(reg_first_name.getText().toString()) &&
            ...
            RegPatientDept = deptSpinner.getSelectedItem().toString();
            ...
            if(reg_employee_password.getText().toString().equals(reg_employee_confirm_password.getText().toString())) {
                ...
                Toast.makeText(patientRegister.this, "Passwords do not match", Toast.LENGTH_LONG).show();
            }

        } else {
            Toast.makeText(patientRegister.this, "No field should be empty", Toast.LENGTH_LONG).show();
        }
    ...
    public void volleyJsonObjectRequest(String url) {
        ...
        StringRequest jsonObjectReq = new StringRequest(Request.Method.POST, url,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (success == 1) {
                                ...
                                Toast.makeText(patientRegister.this, "Failed to create your company.", Toast.LENGTH_LONG).show();
                            }
            ...
            protected Map<String, String> getParams() {
                ...
                httpParams.put(KEY_EMPLOYEE_DEPT, RegPatientDept);
