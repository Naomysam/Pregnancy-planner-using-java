...
public class patient_dashboard extends AppCompatActivity {
    ...
    public CardView Task, AoB, Communication, Reports, DueDate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DueDate = (CardView) findViewById(R.id.due_date);
        ...
        DueDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(getApplicationContext(), due_date_patient.class);
                startActivity(i);
                finish();
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (success == 1) {
                                ...
                                Toast.makeText(patient_dashboard.this, "Failed to get user information.", Toast.LENGTH_LONG).show();
                            }
