...
public class reports_employer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            volleyJsonCalendarRequest(BASE_URL + "show_manager_tasks_monthly.php",calendar);
    ...
    public void process_booked_days(String response,final Calendar calendar) throws JSONException, ParseException {
        ...
        Toast.makeText(reports_employer.this, ""+calendar.getTime(), Toast.LENGTH_LONG).show();
