...
public class taskAdapter extends RecyclerView.Adapter<taskViewHolder>
{
                                                               ...
                                                               int viewType)
    {
        ...
        View photoView = inflater.inflate(R.layout.activity_taskpage_doctor,
                parent, false);
                                 ...
                                 final int position)
    {
        ...
        viewHolder.btn_task_comment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view){
                ...
                Intent i = new Intent(context, comment_doctor.class);
        ...
        viewHolder.btn_task_update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view){
                ...
                Intent i = new Intent(context, update_doctor.class);
                i.putExtra("Task Id", list.get(position).task_id);
                i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                context.startActivity(i);
