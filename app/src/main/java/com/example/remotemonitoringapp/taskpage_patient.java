...
public class taskpage_patient extends AppCompatActivity {

    taskPatientAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_task_patient);
    ...
    public void load_recycler(String json) throws JSONException
    {
        ...
        for(int i=0; i<jsonArray.length();i++) {
            ...
            list.add(new taskData("Name :"+jObject.getString("task"),"Appointment date: "+jObject.getString("deadline"),
                    "Doctor: "+jObject.getString("employer"),jObject.getString("task_id")));

        }

        recyclerView = (RecyclerView)findViewById(R.id.recyclerView);
        adapter = new taskPatientAdapter(list, getApplication());
        recyclerView.setAdapter(adapter);
        recyclerView.setLayoutManager(new LinearLayoutManager(taskpage_patient.this));
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (success == 1) {
                                ...
                                Toast.makeText(taskpage_patient.this, "Failed to get user information.", Toast.LENGTH_LONG).show();
                            }
