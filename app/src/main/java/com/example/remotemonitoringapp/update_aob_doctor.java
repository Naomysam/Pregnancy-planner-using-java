...
public class update_aob_doctor extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        Intent i = new Intent(getApplicationContext(), aob_doctor.class);
        startActivity(i);
        finish();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_aob_doctor);
        ...
        update_aob_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Toast.makeText(update_aob_doctor.this,
        ...
        delete_aob_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(update_aob_doctor.this);
    ...
    public void update_aob() {
        ...
        if (!STRING_EMPTY.equals(aob_title.getText().toString())) {
            ...
            PatientEmail = employeeSpiner.getSelectedItem().toString();

            volleyJsonObjectRequest(BASE_URL + "update_aob.php");


        } else {
            Toast.makeText(update_aob_doctor.this, "No field should be empty", Toast.LENGTH_LONG).show();
        }
    ...
    public void volleyJsonObjectRequest(String url) {
        ...
        StringRequest jsonObjectReq = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            Toast.makeText(update_aob_doctor.this, response, Toast.LENGTH_LONG).show();
                            ...
                            if (success == 1) {
                                Toast.makeText(update_aob_doctor.this, "AOB updated", Toast.LENGTH_LONG).show();
                                load_dashboard();
                            } else {
                                Toast.makeText(update_aob_doctor.this, "Failed to update AOB.", Toast.LENGTH_LONG).show();
                            }
            ...
            protected Map<String, String> getParams() {
                ...
                httpParams.put(KEY_EMPLOYEE_EMAIL, PatientEmail);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if((jsonObject.get("success").toString()).equals("1")) {
                                Toast.makeText(update_aob_doctor.this, jsonObject.get("message").toString(), Toast.LENGTH_LONG).show();

                                Intent i = new Intent(update_aob_doctor.this, aob_doctor.class);
                                startActivity(i);
