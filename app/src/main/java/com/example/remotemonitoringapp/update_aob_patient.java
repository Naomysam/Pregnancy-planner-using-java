...
public class update_aob_patient extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        Intent i = new Intent(getApplicationContext(), aob_patient.class);
        startActivity(i);
        finish();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        update_aob_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Toast.makeText(update_aob_patient.this,
        ...
        delete_aob_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(update_aob_patient.this);
    ...
    public void update_aob() {
        ...
        if (!STRING_EMPTY.equals(aob_title.getText().toString())) {
            ...
            Toast.makeText(update_aob_patient.this, "No field should be empty", Toast.LENGTH_LONG).show();
        }
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (success == 1) {
                                Toast.makeText(update_aob_patient.this, "AOB updated", Toast.LENGTH_LONG).show();
                                load_dashboard();
                            } else {
                                Toast.makeText(update_aob_patient.this, "Failed to update AOB.", Toast.LENGTH_LONG).show();
                            }
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if((jsonObject.get("success").toString()).equals("1")) {
                                Toast.makeText(update_aob_patient.this, jsonObject.get("message").toString(), Toast.LENGTH_LONG).show();

                                Intent i = new Intent(update_aob_patient.this, aob_patient.class);
                                startActivity(i);
