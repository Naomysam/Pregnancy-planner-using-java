...
public class update_doctor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        update_task_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Toast.makeText(update_doctor.this,
        ...
        delete_task_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(update_doctor.this);
        ...
        verify_task_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(update_doctor.this);
                alertDialogBuilder.setTitle("Verify appointment...");
                alertDialogBuilder.setMessage("Are You sure?");
                alertDialogBuilder.setPositiveButton("Yes",
                        new DialogInterface.OnClickListener() {
                            @Override
    ...
    public void update_task() {
        ...
        if (!STRING_EMPTY.equals(task_description.getText().toString()) &&
            ...
            Toast.makeText(update_doctor.this, "No field should be empty", Toast.LENGTH_LONG).show();
        }
    ...
    public void volleyJsonObjectRequest(String url) {
        ...
        progressDialog.setMessage("Updating appointment. Please wait...");
        progressDialog.show();
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (success == 1) {
                                Toast.makeText(update_doctor.this, "Appointment updated", Toast.LENGTH_LONG).show();
                                load_dashboard();
                            } else {
                                Toast.makeText(update_doctor.this, "Failed to update appointment.", Toast.LENGTH_LONG).show();
                            }
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if((jsonObject.get("success").toString()).equals("1")) {
                                Toast.makeText(update_doctor.this, jsonObject.get("message").toString(), Toast.LENGTH_LONG).show();

                                Intent i = new Intent(update_doctor.this, Task.class);
                                startActivity(i);
    ...
    public void volleyVerifyTaskRequest(String url)  {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(this);
        progressDialog.setMessage("Verifying appointment...");
        progressDialog.show();
