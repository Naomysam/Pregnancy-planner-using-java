...
public class upload_aob_doctor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_aob_doctor);
        ...
        try {
            ...
            volleyFetchPatientListRequest(BASE_URL + "show_all_dept_employees.php");
        ...
        create_aob_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Toast.makeText(upload_aob_doctor.this,
    ...
    public void create_aob() {
        ...
        if (!STRING_EMPTY.equals(aob_title.getText().toString())) {
            ...
            Toast.makeText(upload_aob_doctor.this, "No field should be empty", Toast.LENGTH_LONG).show();
        }
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            Toast.makeText(upload_aob_doctor.this, response, Toast.LENGTH_LONG).show();
                            ...
                            if (success == 1) {
                                Toast.makeText(upload_aob_doctor.this, "AOB created", Toast.LENGTH_LONG).show();
                                load_dashboard();
                            } else {
                                Toast.makeText(upload_aob_doctor.this, "Failed to create AOB.", Toast.LENGTH_LONG).show();
                            }
