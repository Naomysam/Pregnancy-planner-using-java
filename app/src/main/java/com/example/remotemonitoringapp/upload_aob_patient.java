...
public class upload_aob_patient extends AppCompatActivity {
        ...
        create_aob_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Toast.makeText(upload_aob_patient.this,
    ...
    public void create_aob() {
        ...
        if (!STRING_EMPTY.equals(aob_title.getText().toString())) {
            ...
            Toast.makeText(upload_aob_patient.this, "No field should be empty", Toast.LENGTH_LONG).show();
        }
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (success == 1) {
                                Toast.makeText(upload_aob_patient.this, "AOB created", Toast.LENGTH_LONG).show();
                                load_dashboard();
                            } else {
                                Toast.makeText(upload_aob_patient.this, "Failed to create AOB.", Toast.LENGTH_LONG).show();
                            }
