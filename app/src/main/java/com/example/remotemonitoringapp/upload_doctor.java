...
public class upload_doctor extends AppCompatActivity {
        ...
        create_task_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Toast.makeText(upload_doctor.this,
    ...
    public void create_task() {
        ...
        if (!STRING_EMPTY.equals(task_description.getText().toString()) &&
            ...
            Toast.makeText(upload_doctor.this, "No field should be empty", Toast.LENGTH_LONG).show();
        }
    ...
    public void volleyJsonObjectRequest(String url) {
        ...
        progressDialog.setMessage("Creating appointment. Please wait...");
        progressDialog.show();
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (success == 1) {
                                Toast.makeText(upload_doctor.this, jsonObject.getString("message"), Toast.LENGTH_LONG).show();
                                load_dashboard();
                            } else {
                                Toast.makeText(upload_doctor.this, jsonObject.getString("message"), Toast.LENGTH_LONG).show();
                            }
